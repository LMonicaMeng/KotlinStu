package com.kotlin.restukotlin.BuiltinTypes.function
...
//    (Foo,String,Long)->Any = Foo.(String,Long)->Any = Function<Foo,String,Long,Any>
...
fun multiReturnValue(): Triple<Int, Long, Double> {
